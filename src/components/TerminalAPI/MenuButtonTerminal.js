...
function MenuButtonTerminal({
  ...
  // console.log("locations from 360 in term: ", locations);
  ...
  // console.log("Location name in Menu ButtonTerminal:", locationName);
  // console.log("Location objectt in Menu ButtonTerminal:", locations[0].id);
  ...
  const handleNavigateSupport = () => {
    if (isLocation) {
      console.log("isLocation from terminals: ", isLocation);
      navigate(`/support`, {
        state: {
          isLocation: true,
          location,
          locationName: locations[0].id,
          business_id: business_id,
...
export default MenuButtonTerminal;
